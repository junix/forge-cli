...
class RichRenderer(BaseRenderer):
    ...
    def __init__(
        ...
        config: Optional[RichDisplayConfig] = None,
    ...
    def _create_response_body(self, response: Response) -> Optional[Group]:
    ...
    def _create_tool_information(self, response: Response) -> Optional[Panel]:
    ...
    def _format_tool_item(self, tool_item: Any) -> Optional[Text]:
    ...
    def _create_reasoning_content(self, response: Response) -> Optional[Panel]:
    ...
    def _create_citation_content(self, response: Response) -> Optional[Panel]:
    ...
    def _format_inline_annotations(self, annotations: List[Any]) -> Optional[Text]:
